...
const kanbanBoardVariants = cva(
  "flex gap-6 p-6 overflow-x-auto min-h-screen",
  {
    variants: {
      variant: {
        default: "bg-gray-50 dark:bg-gray-900",
        modern: "bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-950 dark:to-purple-950",
        minimal: "bg-white dark:bg-gray-800",
        neon: "bg-black",
        glass: "bg-gradient-to-br from-blue-900/20 to-purple-900/20 backdrop-blur-lg",
        premium: "bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50 dark:from-purple-950 dark:via-pink-950 dark:to-blue-950",
      },
    },
    defaultVariants: {
      variant: "default",
...
const kanbanColumnVariants = cva(
  "flex flex-col min-w-[300px] max-w-[350px] rounded-xl transition-all duration-300",
  {
    variants: {
      variant: {
        default: "bg-white border border-gray-200 shadow-sm dark:bg-gray-800 dark:border-gray-700",
        modern: "bg-white/80 backdrop-blur-sm border border-gray-200/50 shadow-lg dark:bg-gray-800/80 dark:border-gray-700/50",
        minimal: "bg-gray-100 dark:bg-gray-700",
        neon: "bg-black border-2 border-cyan-400 shadow-lg shadow-cyan-400/25",
        glass: "bg-white/10 backdrop-blur-md border border-white/20",
        premium: "bg-gradient-to-br from-white to-gray-50 border border-purple-200 shadow-lg dark:from-gray-800 dark:to-gray-900 dark:border-purple-800",
      },
    },
    defaultVariants: {
      variant: "default",
...
const kanbanCardVariants = cva(
  "p-4 rounded-lg cursor-grab active:cursor-grabbing transition-all duration-200 group",
  {
    variants: {
      variant: {
    ...
    return (
      ...
      >
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {card.assignee && (
                          <div className="flex items-center gap-1">
                            ...
                            <span className="opacity-70">{card.assignee.name}</span>
                          </div>
                        )}
                      </div>
        ...
        {showAddColumn && editable && (
          <motion.div
            className={cn(
              "min-w-[300px] max-w-[350px] p-6 border-2 border-dashed rounded-xl transition-all duration-200 hover:bg-gray-50 dark:hover:bg-gray-800/50 cursor-pointer",
              variant === 'neon' && "border-cyan-400/50 hover:border-cyan-400 hover:bg-cyan-400/10",
              variant === 'glass' && "border-white/30 hover:border-white/50 hover:bg-white/10",
              variant === 'premium' && "border-purple-300 hover:border-purple-400 hover:bg-purple-50 dark:border-purple-700 dark:hover:border-purple-600 dark:hover:bg-purple-950",
              !['neon', 'glass', 'premium'].includes(variant || '') && "border-gray-300 dark:border-gray-600"
